...
class HAN(nn.Module):
    def __init__(self, n_resgroups=10, n_resblocks=20, n_feats=128, reduction=16, scale=2,
                 in_chans=3, img_range=1.0, res_scale=1, conv=common.default_conv):
