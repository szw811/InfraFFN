...
def main():
    ...
    model_name = '331628_G'     # 'msrresnet_x4_gan' | 'msrresnet_x4_psnr'
    ...
    # load model
    # ----------------------------------------
    from models.network_mixsr_baseline import MixSR as net

    # classicalSR_s64w8_SwinIR-M_x4
    ...
    # lightweightSR_s64w8_SwinIR-S_x4
    # model = net(upscale=4, in_chans=3, img_size=64, window_size=8,
    #             img_range=1., depths=[6, 6, 6, 6], embed_dim=60, num_heads=[6, 6, 6, 6],
    #             mlp_ratio=2, upsampler='pixelshuffledirect', resi_connection='1conv')
    # param_key_g = 'params'

    # realSR_BSRGAN_DFO_s64w8_SwinIR-M_x4_PSNR/GAN
    # model = net(upscale=4, in_chans=3, img_size=64, window_size=8,
    #             img_range=1., depths=[6, 6, 6, 6, 6, 6], embed_dim=180, num_heads=[6, 6, 6, 6, 6, 6],
    #             mlp_ratio=2, upsampler='nearest+conv', resi_connection='1conv')
    # param_key_g = 'params_ema'

    # realSR_BSRGAN_DFOWMFC_s64w8_SwinIR-L_x4_PSNR/GAN
    # model = net(upscale=4, in_chans=3, img_size=64, window_size=8,
